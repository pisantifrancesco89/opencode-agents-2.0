    ...
    cat > "$PROJECT_DIR/opencode.jsonc" << 'OPEOC'
{
  ...
  //
  // Modelli disponibili:
  //   opencode/*       = modello del piano OpenCode Go
  //   zenmux/*         = modello gratuito di ZenMux (deepseek, gemini, qwen, glm)
  //   anthropic/*      = Claude via API diretta
  //   openai/*         = GPT via API diretta
  //
  ...
  "agent": {
    ...
    "database-specialist":{ "model": "zenmux/deepseek/deepseek-v4-flash", "temperature": 0.2 },
    ...
    "mobile-specialist":  { "model": "zenmux/qwen/qwen3.5-plus",         "temperature": 0.2 },
    ...
    "ui-specialist":      { "model": "zenmux/qwen/qwen3.5-plus",         "temperature": 0.3 }
  }
}
OPEOC
